...
import pt.isel.pdm.chess4android.offline.game.CELL_HEIGHT
import pt.isel.pdm.chess4android.offline.game.SIDE
...
fun BuildSolvedPuzzleScreen(
    ...
    val viewModel = hiltViewModel<SolvedActivityViewModel>()
